...
Has the model been trained in a distributed setting?	Yes, using Meta's custom built GPU cluster.
What was the real-time power consumption (in Watts) of the GPU during the workflow?	700W per GPU.
Which inputs influenced the output in the workflow?	Publicly available online data (up to 9T tokens), Llama 3.1 logits.
What is the total energy use for completing the workflow?	Not specified in kWh; 916k GPU hours used.
...
What is the science domain of the model?	General natural language processing (multilingual text and code).
...
What is the intended use of this model?	Commercial and research use in multiple languages; assistant-like chat, agentic applications.
