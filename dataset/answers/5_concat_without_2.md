...
List all input files with size larger than 100Mb	data/train-*
List all different file types used as input	string, int64
...
What are the designed uses for this model?	Email and URL phishing detection
...
What is the intended use of this model?	Phishing detection for emails and URLs
