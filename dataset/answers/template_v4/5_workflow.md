...
What is the specific task for which the dataset was created?	Email and URL phishing classification
What is the size in byte of one sample?	
What is the total size of the whole dataset?	
What are the designed uses for this model?	4-class email/URL phishing classification
