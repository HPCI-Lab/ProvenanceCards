...
Which inputs influenced the output in the workflow?	base-model, phishing-dataset
...
What is the data type of the ground truth (if present)?	int64 (ClassLabel)
What is the specific task for which the dataset was created?	Multi-class Classification (phishing detection)
What is the size in byte of one sample?	answer not found
What is the total size of the whole dataset?	67150692
What are the designed uses for this model?	Sequence classification, token classification, question answering, masked language modeling, next sentence prediction
...
What is the science domain of the model?	Natural Language Processing
What is the task solved by this model (regression or classification or forecast etc.)?	Classification
What is the intended use of this model?	Phishing email and URL classification
