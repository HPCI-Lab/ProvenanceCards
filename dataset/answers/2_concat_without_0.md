...
What is the data type of the ground truth (if present)?	Single band mask with integer values (GeoTIFF)
What is the specific task for which the dataset was created?	segmentation geospatial machine learning models
